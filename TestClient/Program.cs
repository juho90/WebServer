...
var apiUri = "http://localhost:29090";
try
{
    var uid = "testuser";

    using var httpClient = new HttpClient { BaseAddress = new Uri(apiUri) };
    ...
    var wsUri = "ws://localhost:25050/ws";

    var socketUri = new Uri(wsUri);
...
while (true)
{
    ...
    try
    {
        var grpcUri = "http://localhost:25050";
